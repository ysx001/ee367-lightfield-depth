...
#[3/5/2021] Modified by Sarah Xu (sarahxu@stanford.edu) to adapt to python 3.7
...
def read_lightfield(data_folder):
    ...
    # print(params)
    # print(params["num_cams_x"], params["num_cams_y"], params["height"], params["width"])
    ...
    for idx, view in enumerate(views):
        ...
        try:
            img = read_img(fpath)
            # print(idx / params["num_cams_x"])
            # print(idx % params["num_cams_y"])
